...
public class AIModel {
    ...
    static {
        AI_MODEL_MAP.put(LLAMA3_70B_CHINESE_CHAT,"https://ai.gitee.com/api/inference/serverless/VNC8U6RP7VVH/chat/completions");
        ...
        AI_MODEL_MAP.put(STABLE_DIFFUSION_3_MEDIUM,"https://ai.gitee.com/api/inference/serverless/CIJ3YQDKHFJ6/text-to-image");
        AI_MODEL_MAP.put(CHAT_TTS,"https://ai.gitee.com/api/inference/serverless/HIMFZFOPRT1O/text-to-speech");
    }
}
